                            ...
                            <table class="table table-hover">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <th>{{$data->halaman_durasi}} Halaman</th>
                                        <td><?php if($data->status == 1){echo "<font color='red'>Berbayar</font>";} else {echo "<font color='blue'>Gratis</font>";} ?></td>
                                        <td><a href="buku/{{$data->id}}/viewfile">{{$data->file}}</td>
                                        <td>
                                            <a href="/buku/{{$data->id}}/edit"
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel"><i class="lnr lnr-book"><b> BUKU</b></i></h5>
                ...
                <form action="/buku/create" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group{{$errors->has('halaman_durasi') ? ' has-error': ''}}">
                        ...
                        <input name="halaman_durasi" type="text" class="form-control" id="inputhalaman_durasi"
                            placeholder="Masukkan jumlah halaman" value="{{old('halaman_durasi')}}">
    ...
    $('.delete').click(function () {
        ...
        swal({
            ...
            .then((willDelete) => {
                ...
                if (willDelete) {
                    window.location = "/buku/" + buku_id + "/delete";
                }
            });
    });
