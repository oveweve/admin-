                ...
                <div class="cool-md-12">
                    <div class="panel">
                        <div class="panel-heading">
                            <h3 class="panel-title"><i class="lnr lnr-music-note"><b> DATA AUDIO</b></i></h3>
                            <br><i>Kotak pencarian untuk mencari nama audio</i>
                            <div class="right">
                            <button type="button" data-toggle="modal" data-target="#exampleModal">
                            <i class="lnr lnr-plus-circle" style="padding:5px;"></i>
                          <b>TAMBAH AUDIO</b></button>
                            </div>
                        </div>
                            ...
                            <table class="table table-hover">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><?php if($data->status == 1){echo "<font color='red'>Berbayar</font>";} else {echo "<font color='blue'>Gratis</font>";} ?></td>
                                        <td><a href="audio/{{$data->id}}/viewfile">{{$data->file}}</td>
                                        <td>
                                            <a href="/audio/{{$data->id}}/edit"
                                                class="btn btn-warning btn-sm">Edit</a>
                                            <a href="#" class="btn btn-danger btn-sm delete" audio-id="{{$data->id}}">Delete</a>
                                        </td>
                                    </tr>
                                    @endforeach
                                </tbody>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel"><i class="lnr lnr-music-note"><b> AUDIO</b></i></h5>
            ...
            <div class="modal-body">
                <form action="/audio/create" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group{{$errors->has('media') ? ' has-error': ''}}">
                        <input name="media" type="hidden" class="form-control" id="inputmedia"
                            value="audio" readonly>
                        @if($errors->has('media'))
                    ...
                    <div class="form-group{{$errors->has('nama') ? ' has-error': ''}}">
                        ...
                        <input name="nama" type="text" class="form-control" id="inputnama1"
                            placeholder="Masukkan nama audio" value="{{old('nama')}}">
                        @if($errors->has('nama'))
                    ...
                    <tr>
                        <td>
                            ...
                            <select name="alat_musik" id="alat_musik" class="selectpicker" data-style="select-with-transition" style="width: 250px;" >
                        ...
                        <td>
                            ...
                            <div class="form-group{{$errors->has('kategori') ? ' has-error': ''}}">
                                ...
                                <select name="kategori" id="kategori" class="selectpicker" data-style="select-with-transition" style="width: 250px;" >
                    ...
                    <input name="harga" type="text" class="form-control" id="inputharga"
...
<script>
    $('.delete').click(function () {
        ...
        var audio_id = $(this).attr('audio-id');
        swal({
                title: "Yakin?",
                text: "mau dihapus data video dengan id " + audio_id + " ?",
                icon: "warning",
                buttons: true,
                dangerMode: true,
            })
            .then((willDelete) => {
                ...
                if (willDelete) {
                    window.location = "/audio/" + audio_id + "/delete";
                }
            });
    });
